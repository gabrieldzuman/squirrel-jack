...
const cleanups = [
  ...
  },
  {
    ...
    description: "Outdoor junk cleared so the space is ready to use again.",
    before: "/services/cleanup-6.webp",
    after: "/services/cleanup-6.6.webp",
  },
  {
    number: "07",
    title: "Final Haul-Away",
    description: "The last unwanted items loaded and the area left clean.",
